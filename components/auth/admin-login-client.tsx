...
export default function AdminLoginClient({ generalSettings }: { generalSettings: any }) {
        ...
        <CardHeader className="space-y-4 text-center bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-lg">
          ...
          <div>
            ...
            <CardDescription className="text-blue-100">
              Sign in to access the {generalSettings?.siteName ?? 'TEMPNOW'} administrator dashboard
            </CardDescription>
          </div>
        </CardHeader>
